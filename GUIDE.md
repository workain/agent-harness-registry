...
| [coding-agent-starter](https://github.com/workain/agent-harness-registry/tree/main/templates/coding-agent-starter) **`first-party`** | MIT | — | [write-up](deep-dives/components/instructions-rules/coding-agent-starter.md) |
