...
def main() -> None:
    ...
    out.append(
        ...
        "`docs/DEMAND-vs-ANTI-SIGNALS-equipment-bundles.md`, merged after independent ROAST "
        "— building on `workain/agent-lab-manager` PR#44's market-atomic verdict) found the "
        "market is overwhelmingly atomic "
