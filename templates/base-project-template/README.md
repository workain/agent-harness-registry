...
[deep-dive](../../deep-dives/components/instructions-rules/base-project-template/); read that for *why*, not
just *what*.
...
it); the [deep-dive](../../deep-dives/components/instructions-rules/base-project-template/) carries the evidence
