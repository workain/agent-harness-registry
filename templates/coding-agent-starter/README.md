...
> § Workspace trust, снято 2026-09-24) говорит дословно: в интерактивной сессии хуки из любых
> файлов настроек не работают, «until you accept the workspace trust dialog for the folder,
> **or for a parent directory whose trust extends to it**»; в `-p`/SDK-сессии диалога нет и
> папка считается доверенной. Вторая половина оговорки решает дело в обе стороны: если
> каталог, в котором вы распаковали шаблон, уже доверен, новая папка наследует доверие и хук
> работает сразу; если нет — до диалога не работает. Что именно у вас, шаблон знать не может,
> и потому не утверждает.
