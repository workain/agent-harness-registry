...
Шестнадцать файлов, ни одного лишнего: каждый отвечает на один вопрос, который
иначе агент решит за вас сам.
...
> `CLAUDE.md` тут **называет** этот файл явным указателем: так правило находится
...
Скиллов, субагентов, MCP, CI, профилей, лицензии. Не потому что это неважно —
