...
а не вывод из данных. Обе части этого абзаца взяты из обзора источников, сделанного не в
этом репозитории, и здесь не перепроверялись — см. `unverified:` каталожной записи.
